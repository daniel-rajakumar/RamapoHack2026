import { MATCH_DURATION_MS, ROOM_CODE_CHARS, ROOM_CODE_LENGTH } from "./config.js";
import type { PlayerView, Room } from "./types.js";
import { createInitialTargets } from "./targets.js";
