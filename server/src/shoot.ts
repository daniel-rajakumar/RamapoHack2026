import { MATCH_DURATION_MS, SERVER_RATE_LIMIT_PER_SEC, SERVER_SHOT_COOLDOWN_MS } from "./config.js";
import { clamp01 } from "./validation.js";
import { spawnTarget } from "./targets.js";
import type { ErrorCode, QueuedShot, Room, ShotProcessResult } from "./types.js";
